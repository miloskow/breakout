...
class Level(object):
    ...
    images = {
        ...
        "game_over_background" : pygame.image.load(r'assets\game_over_panel.png')
    }
    def __init__(self, difficulty = "easy"):
        ...
        self.restart_button = Button(250, 350)
        self.init_game()
    ...
    def game_over(self, surface):
        surface.blit(self.images["game_over_background"], (0, 0))

        font = pygame.font.SysFont("arial", 60)

        text = font.render("GAME OVER", True, (255, 0, 0))
        text_rect = text.get_rect(center=(self.sw//2, self.sh//2 - 40))
